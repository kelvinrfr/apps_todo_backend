...
namespace TodoApp.WebApi.Controllers.Todo.v1
{
    ...
    {
        private readonly ILogger<TodoControllerBase> _logger;
        ...
        public async Task<IActionResult> Create([FromBody] TodoItemPostRequest request)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(typeof(ErrorDetailsResponse), StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> Change([Required][FromRoute] long id, [FromBody] TodoItemPatchRequest request)
        {
